...
public class TicTacToeBoard extends View {
    ...
    private int celSize = getWidth()/3;
    ...
    private void drawHorizontalLine(Canvas canvas, int row, int col) {
        canvas.drawLine(col, row*celSize + (float)celSize/2,
                                        celSize*3, (float)row*celSize + celSize/2,
                                         paint);
    }

    private void drawVerticalLine(Canvas canvas, int row, int col) {
        canvas.drawLine(col*celSize + (float)celSize/2, row,
                                col*celSize + (float)celSize/2, celSize*3,
                                 paint);
    }

    private void drawDiagonalLinePos(Canvas canvas) {
        canvas.drawLine(0, celSize*3,
                                celSize*3, 0,
                                 paint);
    }
